			...
			<div className="p-3 shadow-md bg-white">
				...
				{orden.tiempoetrega > 0 && (
					<p className="text-gray-700">Tiempo de Entrega: {" "}
						<span className="font-bold">{orden.tiempoetrega} Minutos</span>
					</p>
				)}

				{!orden.completado && orden.tiempoetrega > 0 && (
					<button
						type="submit"
